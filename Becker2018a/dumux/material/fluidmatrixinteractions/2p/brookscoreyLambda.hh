...
#include "brookscoreyparamsLambda.hh"
...
public:
    ...
    *
    ...
    static Scalar pc(const Params &params, Scalar swe)
    {
        ...
        return params.pe()*pow(swe, -1.0/params.lambdaPc());
    }
    ...
    static Scalar sw(const Params &params, Scalar pc)
    {
        ...
        Scalar tmp = pow(pc/params.pe(), -params.lambdaPc());
    ...
    */
    static Scalar dpc_dswe(const Params &params, Scalar swe)
    {
        ...
        return - params.pe()/params.lambdaPc() * pow(swe, -1/params.lambdaPc() - 1);
    }
    ...
    static Scalar dswe_dpc(const Params &params, Scalar pc)
    {
        ...
        return -params.lambdaPc()/params.pe() * pow(pc/params.pe(), - params.lambdaPc() - 1);
    }
    ...
    static Scalar krw(const Params &params, Scalar swe)
    {
        ...
        return pow(swe, 2.0/params.lambdaKr() + 3);
    }
    ...
    static Scalar krn(const Params &params, Scalar swe)
    {
        ...
        Scalar exponent = 2.0/params.lambdaKr() + 1;
        Scalar tmp = 1. - swe;
    ...
    static Scalar dkrn_dswe(const Params &params, Scalar swe)
    {
        ...
        return
            2.0*(swe - 1)*(
                1 +
                pow(swe, 2.0/params.lambdaKr())*(
                    1.0/params.lambdaKr() + 1.0/2 -
                    swe*(1.0/params.lambdaKr() + 1.0/2)
                    )
                );
    }
